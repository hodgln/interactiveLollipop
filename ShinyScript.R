...
geneSymbols <- read.csv("/Users/danhodgin/Documents/University/Intercalation/annotation/combinedBRAFKRAS.csv")["Hugo_Symbol"]
...
# change the file path to your own
mutation.csv <- "/Users/danhodgin/Documents/University/Intercalation/annotation/combinedBRAFKRAS.csv"
